    ...
    return (
        <>
            <div style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                ...
                <button disabled={text.length === 0} className="btn btn-primary mx-1 my-1" onClick={handleInvClick}>Reverse</button>
            ...
            <div className="container my-2" style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                ...
                <p>{(text.split(/\s/).filter((element) => { return element.length !== 0 }).length)} words and {text.length} characters</p> {/* filter function returns only boolean(ture or false)  */}
